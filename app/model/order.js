...
module.exports = app => {
  ...
  Model.createNewOrder = async ({ user_id, address, best_time, transation }) => {
    // validate somehow
    ...
    const created = await Model.create(order, { transation });
    return created;
  };
  ...
  Model.updateOrder = async (order, { transation }) => {
    const { id } = order;
