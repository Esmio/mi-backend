...
/**
 * @apiVersion 0.1.0
 * @api {GET} /product/:product_id 商品管理-获取单个商品
 * @apiGroup ADMIN/PRODUCT
 *
 * @apiParam {String} product_id 商品id
 *
 * @apiSuccess {String} default_goods_id 默认skuid
 * @apiSuccess {Object} product_info 产品信息
 * @apiSuccess {Object} product_info.activity_tips 活动提示
 ...
 * @apiSuccess {Array} product_info.goods_ids skuid数组
 *
 * @apiSuccessExample Success-Response:
  {
    ...
    "description": "success",
    "data": {
      "default_goods_id": "189741e0-df4d-4c62-90c0-fbc50a692500",
      "product_info": {
        "activity_tips": {
          "action": {},
          "img_url": ""
